			...
			<td>
				...
				<xsl:if test="hardware/drives">
					...
					<xsl:if test="hardware/drives/drive/@type = 'floppy'">
						...
						/
						<xsl:value-of
							select="hardware/drives/drive/@formfactor " />
						/
					...
					<xsl:if test="hardware/drives/drive/@type = 'cd'">
						<xsl:value-of
							select="hardware/drives/drive[@type = 'cd']/@type" />
						<br />
					</xsl:if>

					<xsl:if test="hardware/drives/drive/@type = 'tape'">
						<xsl:value-of
							select="hardware/drives/drive[@type = 'tape']/@type" />
						/
						<xsl:value-of
							select="hardware/drives/drive[@type = 'tape']/@size" />
